...
/**
 * Zume_QR_Post_Type Post Type Class
 * All functionality pertaining to project update post types in Zume_QR_Post_Type.
 *
 * @package  Disciple_Tools
 * @since    0.1.0
 */
class Zume_QR_Post_Type
{
    /**
     * The post type token.
     *
    ...
    /**
     * Zume_QR_Post_Type The single instance of Zume_QR_Post_Type.
     * @var     object
     * @access  private
     * @since   0.1
     */
    ...
    /**
     * Main Zume_QR_Post_Type Instance
     *
     * Ensures only one instance of Zume_QR_Post_Type is loaded or can be loaded.
     *
     * @since 0.1
     * @static
     * @return Zume_QR_Post_Type instance
     */
...
//                            echo 'Destination: <a href="'. $link .'" target="_blank">'. $link .'</a><br>';
    ...
    public function get_custom_fields_settings() {
        ...
        return apply_filters( 'zume_qr_links_fields_settings', $fields );
